...
## Corpus Check
- 9 files · ~806,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 124 nodes · 144 edges · 23 communities (14 shown, 9 thin omitted)
...
Cohesion: 0.13
Nodes (27): about.html (About Us), Agenda Day-by-Day Program List, agenda.html (Agenda), Bye-Bye Brunch (FACT agenda event), Delegate Day (FACT agenda event), Palenke (FACT agenda event), V-Show / Variety Show (FACT agenda event), Disclosed Placeholder Content Practice (+19 more)
...
### Community 9 - "P0: Zero working conversion action anywhere on the site"
Cohesion: 0.67
