# Graph Report - fact2026  (2026-08-15)

## Corpus Check
- 9 files · ~806,421 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 123 nodes · 143 edges · 22 communities (13 shown, 9 thin omitted)
- Extraction: 82% EXTRACTED · 17% INFERRED · 1% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.81)
...
- `P2: TOC index numerals overflowing on index.html` --references--> `Homepage Table of Contents (six-entry nav)`  [EXTRACTED]
  .impeccable/critique/2026-08-10T03-03-35Z__index-html.md → index.html
...
Cohesion: 0.11
Nodes (30): about.html (About Us), Agenda Day-by-Day Program List, agenda.html (Agenda), Bye-Bye Brunch (FACT agenda event), Delegate Day (FACT agenda event), Palenke (FACT agenda event), V-Show / Variety Show (FACT agenda event), Disclosed Placeholder Content Practice (+22 more)
...
## Knowledge Gaps
- **49 isolated node(s):** `Design Health Score`, `Design Specificity Verdict`, `Overall Impression`, `What's Working`, `Priority Issues` (+44 more)
...
- **What is the exact relationship between `Donate Button (CTA)` and `Login Button`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FACT 2026 Index.html Design Critique Report` connect `FACT 2026 Index.html Design Critique Report` to `P1: Placeholder surface area stacks up and undercuts credibility`?**
...
- **Should `FACT 2026 Index.html Design Critique Report` be split into smaller, more focused modules?**
